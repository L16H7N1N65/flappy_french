...
class Bird(pygame.sprite.Sprite):
    def __init__(self, images, avatar_image, initial_position, select_sound, pass_pipe_sound, bird_type='bird1'):
        ...
        self.alternate_images = {
            'bird1': [pygame.image.load('../assets/birds/bird1_flap.png').convert_alpha(),
                      pygame.image.load('../assets/birds/bird1_flop.png').convert_alpha()],
            'bird3': [pygame.image.load('../assets/birds/bird3_flap.png').convert_alpha(),
                      pygame.image.load('../assets/birds/bird3_flop.png').convert_alpha()],
            'bird4': [pygame.image.load('../assets/birds/bird4_flap.png').convert_alpha(),
                      pygame.image.load('../assets/birds/bird4_flop.png').convert_alpha()],
        }
